...
import { useTournamentStore, DEMO_GRAND_FINAL, RaceResult, TEAM_COLORS, computeTeamRankings, computeSfMatchups, computeMatchWinner } from '@/store/tournament';
...
export default function GrandFinalResults() {
  ...
  const setGrandFinalResults = useTournamentStore(s => s.setGrandFinalResults);
  ...
  const result = grandFinalResults.length === 4 ? computeMatchWinner(grandFinalResults, teamA, teamB) : null;
